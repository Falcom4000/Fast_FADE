FADE_Release_Python2 MATLAB Python Package
...
2. Installing the FADE_Release_Python2 Package

A. Change to the directory that contains the file setup.py and the subdirectory 
FADE_Release_Python2. If you do not have write permissions, copy all its contents to a 
...
3. Using the FADE_Release_Python2 Package

The FADE_Release_Python2 package is on your Python path. To import it into a Python 
